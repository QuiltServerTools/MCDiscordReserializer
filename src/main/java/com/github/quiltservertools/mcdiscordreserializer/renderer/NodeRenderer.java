...
package com.github.quiltservertools.mcdiscordreserializer.renderer;
...
public interface NodeRenderer<O> {
     ...
     * @param renderWithChildren a function to allow rendering a node recursively
     * @return the renderTo input with the node applied to it
     * @see #render(Object, dev.vankka.simpleast.core.node.Node, MinecraftSerializerOptions, java.util.function.Function)
     */
